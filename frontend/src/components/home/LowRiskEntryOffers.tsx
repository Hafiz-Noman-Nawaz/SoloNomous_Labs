...
import { ShieldCheck, CheckCircle2, Zap, FileCode2, Sparkles } from 'lucide-react';
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden" id="entry-offers">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="glass-card p-8 rounded-3xl relative flex flex-col justify-between hover:border-purple-500/40 transition-all shadow-xl">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-700 dark:text-purple-300 text-xs font-semibold uppercase tracking-wider mb-4">
              ...
              <div className="space-y-2.5 pt-4 border-t border-slate-200/80 dark:border-white/10 mb-8 text-xs text-slate-700 dark:text-slate-200">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 dark:bg-white/10 dark:hover:bg-white/15 text-white font-semibold text-xs sm:text-sm transition-all border border-slate-800 dark:border-white/15 flex items-center justify-center gap-2 cursor-pointer shadow-sm"
            >
          ...
          <div className="glass-card p-8 rounded-3xl border-purple-500/40 relative flex flex-col justify-between shadow-2xl shadow-purple-950/20 ring-1 ring-purple-500/30">
            ...
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-4">
